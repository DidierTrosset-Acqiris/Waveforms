...
class MultiRecord():
    ...
    @property
    def ScaleFactor( self ):
        return self.mwfms[0].ScaleFactor

    @property
    def ScaleOffset( self ):
        return self.mwfms[0].ScaleOffset
...
class _DDCMultiWaveform():
    ...
    >>> w = _DDCMultiWaveform( ( samples, 2, [12, 12], [0, 32], [-7e-11, -3e-11], [0.0, 0.0], [2e-3, 3e-3], 6.25e-10, 2.0/32768, 0.0, 0 ) )
    >>> print( w.ActualPoints )
    [12, 12]
    >>> print( w.InitialXOffset )
    [-7e-11, -3e-11]
...
class DDCMultiRecord():
    ...
    [ 12315     -1     97     -1 -11877      3   -408     -1  12283     -2
         65      0]
    >>> print( r1[0].Samples )
    [ 12313     -1     39      1 -11923      1   -418      0  12289     -3
         99      1]
